...
public class OBJLoaderOP implements ICustomModelLoader
{
    public static final OBJLoaderOP INSTANCE = new OBJLoaderOP();
    ...
    {
        return OBJLoaderOP.getModelFromOBJ(modelLocation, visibleGroups, TRSRTransformation.identity());
    }
    ...
    {
        IModel model = OBJLoaderOP.INSTANCE.loadModel(modelLocation);

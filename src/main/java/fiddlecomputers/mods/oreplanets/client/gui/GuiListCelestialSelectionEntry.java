...
public class GuiListCelestialSelectionEntry implements GuiListExtended.IGuiListEntry
{
    ...
    public void teleport()
    {
        ...
        try
        {
            ...
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimpleOP(EnumSimplePacketMP.S_START_SURVIVAL_PLANET, GCCoreUtil.getDimensionID(this.mc.world), new Object[] { this.mc.world.provider.getDimension(), celestialName }));
        }
        catch (Exception e)
        {

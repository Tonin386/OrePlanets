package fiddlecomputers.mods.oreplanets.utils.tileentity;
...
import fiddlecomputers.mods.oreplanets.utils.world.capability.DoubleChestItemHandlerOP;

public abstract class TileEntityChestOP extends TileEntityLockableLoot implements ITickable, IInventory
{
    private NonNullList<ItemStack> chestContents = NonNullList.withSize(27, ItemStack.EMPTY);
    protected boolean adjacentChestChecked;
    public TileEntityChestOP adjacentChestZNeg;
    public TileEntityChestOP adjacentChestXPos;
    public TileEntityChestOP adjacentChestXNeg;
    public TileEntityChestOP adjacentChestZPos;
    private DoubleChestItemHandlerOP doubleChestHandler;
    ...
    public TileEntityChestOP(Block block)
    {
        this.block = block;
    }

    public TileEntityChestOP(Block block, String name)
    {
        this.block = block;
        this.name = name;
    }
    ...
    public <T> T getCapability(Capability<T> capability, @Nullable EnumFacing facing)
    {
        if (capability == CapabilityItemHandler.ITEM_HANDLER_CAPABILITY)
        {
            ...
            {
                this.doubleChestHandler = DoubleChestItemHandlerOP.get(this);
            }
            if (this.doubleChestHandler != null && this.doubleChestHandler != DoubleChestItemHandlerOP.NO_ADJACENT_CHESTS_INSTANCE)
            {
    ...
    protected void setNeighbor(TileEntityChestOP tile, EnumFacing side)
    {
        if (tile.isInvalid())
        {
            this.adjacentChestChecked = false;

...
import fiddlecomputers.mods.oreplanets.utils.client.RenderUtils;

@SideOnly(Side.CLIENT)
public class GuiElementInfoRegionOP extends Gui
{
    private int width;
    private int height;
    ...
    private final GuiContainerOP parentGui;

    public GuiElementInfoRegionOP(int xPos, int yPos, int width, int height, List<String> tooltipStrings, int parentWidth, GuiContainerOP parentGui)
    {
        this.width = 200;
        this.height = 20;
        this.enabled = true;

...
import fiddlecomputers.mods.oreplanets.utils.enums.EnumEntityTrackerType;
...
public class CommonRegistryUtils
{
    ...
    {
        String name = block.getLocalizedName().substring(5);
    ...
    public void registerBiomeType(Biome biome, @Nonnull BiomeDictionary.Type... biomeType)
    {
        ...
        {
            Biome.MUTATION_TO_BASE_ID_MAP.put(biome, Biome.getIdForBiome(ForgeRegistries.BIOMES.getValue(new ResourceLocation(this.resourcePath + ":" + biome.getRegistryName()))));
        }
    }
